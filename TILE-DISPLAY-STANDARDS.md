...
**Status: fixed and merged (2026-08-17).** `myHubV2` PR #1313 added the `padded` prop; `mysmb-marketplace` PR #581 applied it to all 7 widgets above. Both merged — verified in the tile harness against the real component (not a build artifact), light and dark mode, before opening either.

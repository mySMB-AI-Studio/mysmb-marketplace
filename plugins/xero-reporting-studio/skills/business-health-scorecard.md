...
Use `get_profit_and_loss`, `get_financial_position`, `get_aged_receivables`, and `get_aged_payables`. Targets must come from the user; if absent, offer clearly labeled directional comparisons rather than inventing benchmarks.

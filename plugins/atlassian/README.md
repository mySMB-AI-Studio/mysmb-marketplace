...
All five are capped at 20 rows per the row-limit standard — a "See more" reveal isn't built into the platform yet (see `TILE-DISPLAY-STANDARDS.md` §11), so this is the ceiling until that lands.
